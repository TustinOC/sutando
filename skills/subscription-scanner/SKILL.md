...
5. Provides a "Scan now" button that POSTs to `/paidsubscriptions/scan` — that endpoint writes a task file to `$SUTANDO_WORKSPACE/tasks/` triggering an out-of-cycle scan in the next loop pass
